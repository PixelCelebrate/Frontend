...
import * as API_USERPAGE_UPDATEUSER from "../api/userpage-api";
...
//Form:
class Userpage_updateUser extends React.Component
{
    //Constructor:
    constructor(props) {
        super(props);
    ...
    handleSubmit()
    {
        ...
        //Fara time: Deci 0:
        userToUpdate.Birthday = Birthday + "T00:00:00"; 
        console.log("Birthday: " + userToUpdate.Birthday + ".");
        }

        if(this.state.DateOfJoining === null)
        {
            console.log("DateOfJoining is null!");
            userToUpdate.DateOfJoining = "nothing";
        }
        else
        {
            ...
            //Fara time: Deci 0:
            userToUpdate.DateOfJoining = DateOfJoining + "T00:00:00"; 
            console.log("DateOfJoining: " + userToUpdate.DateOfJoining + ".");
        }
    ...
    updateUser(userToUpdate) {
        return API_USERPAGE_UPDATEUSER.updateUser(userToUpdate, (result, status) => {
               ...
               && result !== "Cannot find user by the username. Try a different username.")
            {
                ...
                window.alert("The user was updated!");
            }
            else {
...
export default withRouter(Userpage_updateUser);
